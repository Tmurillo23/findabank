    ...
    <main className="min-h-screen flex flex-col items-center bg-slate-50 text-slate-950">
      <div className="flex-1 w-full flex flex-col gap-12 items-center py-8">
        ...
        <div className="w-full max-w-5xl px-5">
          <section className="mx-auto max-w-4xl rounded-[2rem] border border-slate-200 bg-white p-10 shadow-2xl shadow-slate-200/50 ring-1 ring-slate-100">
            <div className="space-y-6">
              <p className="rounded-full bg-slate-100 px-4 py-1 text-sm font-semibold uppercase tracking-[0.22em] text-slate-700 w-max">
                Red de donación
              </p>
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <Link
                  href="/sign-up"
                  className="inline-flex items-center justify-center rounded-2xl border border-slate-300 bg-slate-50 px-7 py-3 text-sm font-semibold text-slate-950 transition hover:bg-slate-100"
                >
                  Registrarse
                </Link>
              </div>
